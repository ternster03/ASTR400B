...
# Question 2
#mag_dis_MW_M31 = M31_COM_p - MW_COM_p
#vel_MW_M31 = M31_COM_v - MW_COM_v
#mag_p_MW_M31 = np.round(np.linalg.norm(mag_dis_MW_M31),3)
#mag_v_MW_M31 = np.round(np.linalg.norm(vel_MW_M31),3)
...
# Question 3
#mag_dis_M31_M33 = M31_COM_p - M33_COM_p
#vel_M31_M33 = M31_COM_v - M33_COM_v
#mag_p_M31_M33 = np.round(np.linalg.norm(mag_dis_M31_M33),3)
#mag_v_M31_M33 = np.round(np.linalg.norm(vel_M31_M33),3)
...
# Question 4
# When things are merging, the particles are gonna scatter and we do it iterativly
# we can ignore the outliers that could affect the simulation
